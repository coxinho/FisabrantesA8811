    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Fisabrantes.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(Fisabrantes.Models.ApplicationDbContext context)
        {
            ...
            var Funcionarios = new List<Funcionarios> {
                new Funcionarios  {idFuncionario=1, Nome = "Fernando Sousa", DataNasc = new DateTime (1978,12,5), Rua ="Av. 25 de Abril", NumPorta = "3", Localidade = "Abrantes", CodPostal = "2200-299", NIF = "133765342", DataEntClinica = new DateTime (2017,4,3), CatProfissional = "Fisiatra" , UserName="fernando@gmail.com" },
                new Funcionarios  {idFuncionario=2, Nome = "Sílvia Marques", DataNasc = new DateTime (1965,9,3), Rua ="Rua da Boavista", NumPorta = "17", Localidade = "Vale Zebrinho", CodPostal = "2205-411"  , NIF = "122443879", DataEntClinica = new DateTime (2017,4,3), CatProfissional = "Fisiatra", UserName = "silvia@gmail.com"   },
                ...
                new Funcionarios  {idFuncionario=6, Nome = "Francisco Dias", DataNasc = new DateTime (1977,10,15), Rua ="Rua das Flores", NumPorta = "4", Localidade = "Tomar", CodPostal = "2300-001", NIF = "637213490", DataEntClinica = new DateTime (2017,4,3), CatProfissional = "Fisiatra", UserName = "fdias@gmail.com"  },
